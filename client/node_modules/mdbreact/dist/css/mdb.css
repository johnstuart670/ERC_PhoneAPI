...
.waves-circle {
  ...
  mask-image: radial-gradient(circle, white 100%, black);
...
.btn-brown {
  background-color: rgb(15, 105, 96) ;
  color: #fff !important; }
  .btn-brown:hover {
...
.btn-outline-brown {
  border: 2px solid #bd955a !important;
  background-color: transparent !important;
  color: #bd955a !important; }
...
div.dataTables_wrapper div.dataTables_length input, div.dataTables_wrapper div.dataTables_filter select,
