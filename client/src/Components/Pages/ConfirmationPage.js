        ...
        return (
            <React.Fragment>
                <Container className="mx-auto my-5 col-12">
                    ...
                    <p className="text-center pt-0 my-3 mx-auto brown SuperText col-10">Please have a seat.</p>
                    <p className="text-center pt-1 my-3 mx-auto SuperText brown-text col-8">Your counselor has been notified of your arrival.</p>
                    <div style = {btnMargin} />
                    <Button block color="brown" className="mx-auto my-4 col-10  black-text " onClick={() => { this.updateParentPageState("Landing") }}>
                        <h3 onClick={() => { this.pingT("Myles") }} className="  black-text superSize7 text-capitalize my-auto">Go back to the Home Page</h3>
                    </Button>
                </Container>
            </React.Fragment>
        )
